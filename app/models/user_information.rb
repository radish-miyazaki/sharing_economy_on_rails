class UserInformation < ApplicationRecord
  ...
  validates :family_name_kana, presence: true, format: { with: ZENKAKU_KANA_REGEXP, message: 'は全角で入力してください' },
            allow_blank: true
  validates :given_name_kana, presence: true, format: { with: ZENKAKU_KANA_REGEXP, message: 'は全角で入力してください' },
            allow_blank: true
